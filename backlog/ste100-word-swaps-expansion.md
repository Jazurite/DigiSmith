...
**Status:** Not applied. Raised live during T.1's brainstorm (2026-09-12, as "G.3.1" before the
lineage's 2026-09-13 promotion to its own letter, `T`) as a "we could do more
than just this" aside, deliberately deferred so it doesn't block T.1's initial ship.

## What this covers

T.1 ships `standards/global/ste100-word-swaps.md` adopted whole from AminBlg/SimpleEnglish's
...
Raised as an aside mid-brainstorm, not while T.1's own scope was under discussion. Explicitly
deferred rather than built now — T.1 ships the table as-is (adopted whole, no changes) and this
stays a future enhancement, likely a T.1 follow-up rather than a new T.x child.
