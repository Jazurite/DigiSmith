...
- [Execution Handoff should state its reasoning, not just its choice (W.6 enhancement)](execution-handoff-state-reasoning-w6.md) — surfaced live during Model Router Z.1's planning when Jack had to ask why `executing-plans` was chosen
