...
- [Audience-filtering content-voice skill (G.3.6)](audience-filtering-voice-g3-6.md) — renumbered 2026-09-13 from tentative letter T once G.3 broadened into "AI Voice"; I.1's first progress-comment draft leaked git/PR mechanics at a PO/PM audience
...
- [ASD-STE100 Writing Standard, source narrative (G.3)](ste100-writing-standard-g3.md) — brainstormed 2026-09-12, then split into four children (G.3.1–G.3.4) below; this file holds the source comparison and scoping reasoning, not a standalone build target anymore
