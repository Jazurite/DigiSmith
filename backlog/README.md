...
- [`finishing-a-development-branch` Option 1 never pushes after merging locally](no-push-after-local-merge.md) — confirmed cause of DigiSmith's own 65-commit unpushed `main`; upstream Superpowers gap, not a DigiSmith skill; candidate first activation for map item **W.2+**
