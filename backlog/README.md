...
- [T lineage ("AI Voice") source narrative](ste100-writing-standard-t.md) — brainstormed 2026-09-12 as "G.3", promoted 2026-09-13 to its own top-level letter T; split into six children (T.1–T.6); this file holds the source comparison and scoping reasoning, not a standalone build target anymore
...
- [Expand the ASD-STE100 word-swaps table beyond AminBlg's original list](ste100-word-swaps-expansion.md) — raised live during T.1's brainstorm, deliberately deferred; likely a T.1 follow-up, not a new child
