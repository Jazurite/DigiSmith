...
- [JIRA write-back (I.1): real ADF formatting + multi-repo distribution](jira-write-back-adf-reporting.md) — status lozenges/emoji/expand panels via ADF, plus worktree fan-out learned from EMKT-784
