...
- [Reusable Jira comment templates beyond the single fixed Progress Update shape (I-lineage)](jira-comment-templates.md) — surfaced live on EMKT-799; I.1 has one hardcoded template tied to the PR-deploy flow, no "Investigation Update" shape for incident tickets
