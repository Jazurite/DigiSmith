...
- [`progress-update.md` template is missing a Screenshots/Videos section (Q.1)](jira-progress-update-screenshots-section.md) — found live on EMKT-711; depends on the two items below for a complete design
